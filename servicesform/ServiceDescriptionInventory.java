...
public class ServiceDescriptionInventory {
	...
	public ServiceDescriptionInventory(int sessionServiceID) {
			...
			try{
			    ...
			    ResultSet rs;
			    rs = st.executeQuery("select service_content, service_position_id from services_block_components where user_service_id ="+ this.getServiceID() +" order by service_position_id");
			    i = 0;
			    while( rs.next() ){
	...
	public void store(ServiceDescriptionInventory serviceDescriptionInventory){
		Connection conn = null;
		conn = singleConnect.connectToDatabaseOrDie();
		...
		try{
			...
			System.out.println(this.mainBlockSixData[0]);
			System.out.println(this.mainBlockSixData[1]);
			System.out.println(this.mainBlockSixData[2]);
			System.out.println(this.mainBlockSixData[3]);
			System.out.println(this.mainBlockSixData[4]);
